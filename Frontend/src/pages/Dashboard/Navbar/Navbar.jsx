...
import NotificationPanel from "../Goals/components/NotificationPanel/NotificationPanel.jsx"
import "./Navbar.css"
          ...
          {openMenu === "profile" && (
            <div className="navbar__dropdown navbar__dropdown--profile" role="menu">
              <div className="navbar__profile-head">
                ...
                <div>
                  <p className="navbar__profile-name">Aarav Sharma</p>
                  <p className="navbar__profile-email">aarav@globalpulse.io</p>
                </div>
              </div>
              <div className="navbar__menu-group">
                ...
                <Link to="/dashboard/upgrade" className="navbar__menu-item" onClick={() => setOpenMenu(null)}>
                  <CreditCard size={16} /> Billing
                </Link>
                <Link to="/dashboard/settings" className="navbar__menu-item" onClick={() => setOpenMenu(null)}>
